const TMDB_IMAGE_BASEURL = 'https://image.tmdb.org/t/p/w500';
    ...
    this.get('/movies', function() {
        return {
            data: [{
                ...
                id: 140607,
                attributes: {
                    poster_path: TMDB_IMAGE_BASEURL + '/fYzpM9GmpBlIC893fNjoWCwE24H.jpg',
                    adult: false,
                ...
                id: 102899,
                attributes: {
                    poster_path: TMDB_IMAGE_BASEURL + '/D6e8RJf2qUstnfkTslTXNTUAlT.jpg',
                    adult: false,
